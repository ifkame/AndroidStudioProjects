...
import kotlinx.android.synthetic.main.activity_event_work03.*

class EventWork03 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_event_work03)

        //トースト表示
        Toast.makeText(applicationContext, "EventWork03 が選択されました", Toast.LENGTH_LONG).show()

        //URLをテキストS4に表示（リンクでサイトに飛べる）
